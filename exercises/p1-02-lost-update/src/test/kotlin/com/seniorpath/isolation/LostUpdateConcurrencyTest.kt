 ...
 *
 * RED START: the naive read-modify-write under PostgreSQL READ COMMITTED loses updates, so the
 * final balance is far higher than expected and the assertion fails by design.
 */
@Testcontainers
@SpringBootTest
